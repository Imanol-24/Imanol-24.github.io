...
import $ from "jquery";
  ...
  function datos(){
    ...
    var dbReferencia = db.ref("Alumno");
      ...
      dbReferencia.on("value",function(snapshot){
            ...
            <div>
              <form>
                ...
                <div className="mt-3 d-flex justify-content-end">
                  <Link className="btn btn-danger me-3" to="/PanelMaestro">Cancelar</Link>
                  <Link className="btn btn-primary me-3" to="/PanelMaestro" onClick={modifica}>Editar</Link>
...
export default PanelEditarMaestro
